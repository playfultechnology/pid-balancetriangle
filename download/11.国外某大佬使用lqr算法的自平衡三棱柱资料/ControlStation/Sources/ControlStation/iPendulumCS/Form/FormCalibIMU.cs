...
namespace iPendulumCS
{
	public partial class FormCalibIMU : Form
	{
		...
		{
			// Check X, Y accelerometers are below 30mG and Z accelerometer is below -0.9G
			if (pendulum.SensorsAccX >= 30 * 9.81f / 1000.0f) return false;
			if (pendulum.SensorsAccY >= 30 * 9.81f / 1000.0f) return false;
			if (pendulum.SensorsAccZ >= -900 * 9.81 / 1000.0f) return false;
			return true;
		}
